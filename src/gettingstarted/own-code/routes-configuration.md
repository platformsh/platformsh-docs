...
{% codesnippet "https://raw.githubusercontent.com/platformsh-templates/php/master/.platform/routes.yaml", language="yaml" %}{% endcodesnippet %}
...
>
> * **The [Routes](/configuration/routes.md) documentation for Platform.sh**
