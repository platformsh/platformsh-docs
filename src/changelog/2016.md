...
Support for HTTP/2, read more on our [blog post](https://platform.sh/2017/1/http2/).

# December 2016

## Support Async PHP

Deploy applications like ReactPHP and AmPHP which allow PHP to run as a single-process asynchronous process.
