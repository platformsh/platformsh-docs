...
This large block details all information about all services in the environment.  That includes the resulting configuration objects derived from [`routes.yaml`](/administration/routes.md), [`services.yaml`](/services.md), and [`.platform.app.yaml`](/administration/app-containers.md).
