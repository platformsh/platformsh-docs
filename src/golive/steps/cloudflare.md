...
In order to correctly point DNS to your Platform.sh project, you'll need at the very least the master environment CNAME, in other words the domain of your site before you add a custom domain on the console for that project (or otherwise in the CLI).  This is the value you would get from [Setp 2 of the pre-launch checklist](/golive/checklist.md).
