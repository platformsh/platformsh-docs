...
If you're new to Platform.sh, we recommend starting with the **Big Picture**, in particular [Structure](/overview/structure/), and [Build & Deploy](/overview/build-deploy/) will get you started on the right track to best leverage Platform.sh.
