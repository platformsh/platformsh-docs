...
* [Developing on Platform.sh](gettingstarted/developing.md)
  * [Local development](gettingstarted/local-dev.md)
    * [Download the code](gettingstarted/local-dev/download-code.md)
    * [Connect to services](gettingstarted/local-dev/connect-services.md)
    * [Build site locally](gettingstarted/local-dev/build-locally.md)
    * [Next steps](gettingstarted/local-dev/next-steps.md)
