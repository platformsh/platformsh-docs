...
> HTTP-based applications exposed to the outside world. See the [Routing](/administration/routes.md) section
...
support multiple protocols).  See the [Services](/services.md) section.
