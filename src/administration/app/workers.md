...
Any top-level definitions for [`size`](/administration/app/size.md), [`relationships`](/administration/app/relationships.md), [`access`](/administration/app/access.md), [`disk` and `mount`](/administration/app/storage.md), and [`variables`](/administration/app/variables.md) will be inherited by every worker, unless overridden explicitly.
