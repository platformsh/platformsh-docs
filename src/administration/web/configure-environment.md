...
![env gen settings](/images/mgmt-console/env-settings.png)
...
![env status](/images/mgmt-console/env-status.png)
...
![env email](/images/mgmt-console/env-email.png)
...
![env search](/images/mgmt-console/env-search.png)
...
![Manage users of your Platform.sh environments](/images/mgmt-console/settings-environment-access.png)
...
![Configure Platform.sh environment variables](/images/mgmt-console/settings-variables-environment.png)
...
![Configure Platform.sh environment routes](/images/mgmt-console/routes.png)
