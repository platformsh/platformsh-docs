...
The web URL(s) for the site are listed in the [web UI](/gettingstarted/web.md) under "Access site".

They can also be found on the command line, using the [Platform.sh CLI](/administration/cli.md):
...
Most interactions with Platform.sh require SSH key authentication, and you will need to [set up your SSH keys](/administration/ssh.md) before working on a site.
...
The writable static files in an application - including uploads, temporary and private files - are stored in [mounts](/administration/app/storage.md).

The [CLI](/administration/cli.md) can list mounts inside an application:
