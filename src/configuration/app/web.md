...
### Example configuration for wide-open CORS

The following is an example of setting headers to accept cross origin requests, from any origin (you should be very wary of doing this as it has important security considerations). 
