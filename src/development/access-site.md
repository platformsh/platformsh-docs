...
The web URL(s) for the site are listed in the [management console](/administration/web.html) under "Access site".

They can also be found on the command line, using the [Platform.sh CLI](/development/cli.html):
