...
* explain the ideal workflow with Platform
* access rights
* merge
* create new project
* Drupal specific
...
Note: The environments used in Platform.sh are read-only and are rebuilt with every git push.
...
Platform.sh is currently running PHP 5.4, MariDB MAJOR VERSION
