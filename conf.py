...
latex_documents = [
  ('index', 'platform.tex', u'Platform',
   u'Commerce Guys', 'manual'),
]
...
epub_title = u'platform'
epub_author = u'Commerce Guys'
epub_publisher = u'Commerce Guys'
epub_copyright = u'2014, Commerce Guys'
