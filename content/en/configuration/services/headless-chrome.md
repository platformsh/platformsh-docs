...
{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/chrome-headless.services.yaml" >}}
{{< /highlight >}}

In your `.platform.app.yaml`:

{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/chrome-headless.app.yaml" >}}
{{< /highlight >}}
