...
{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/postgresql.services.yaml" >}}
{{< /highlight >}}

Add a relationship to the service in your ``.platform.app.yaml``:

{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/postgresql.app.yaml" >}}
{{< /highlight >}}
