...
{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/elasticsearch.services.yaml" >}}
{{< /highlight >}}

In your `.platform.app.yaml`:

{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/elasticsearch.app.yaml" >}}
{{< /highlight >}}
