...
{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/mariadb.services.yaml" >}}
{{< /highlight >}}

Oracle-mysql uses the `oracle-mysql` service type:

{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/oracle-mysql.services.yaml" >}}
{{< /highlight >}}
...
{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/mariadb.app.yaml" >}}
{{< /highlight >}}

The same goes for using the `oracle-mysql` service type as well.

{{< highlight yaml >}}
{{< readFile file="content/en/registry/images/examples/full/oracle-mysql.app.yaml" >}}
{{< /highlight >}}
