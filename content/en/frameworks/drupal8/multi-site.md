...
description: |
  Platform.sh supports running <a href="/user_guide/reference/platform-app-yaml-multi-app.html">multiple applications in the same project</a>, and these can be two or more Drupal sites. But they would be separate Drupal instances: they will have their assets separate and live their lives apart, and it would be much better for them not to share the same database (though they could).
---
