    ...
    book: {
        ...
        html: {
            "head:end": function() {
                ...
                + "ga('create', 'UA-4064131-7', 'auto' , {'name': 'marketplace'});"
                + "ga('marketplace.send', 'pageview');"
                + "ga('send', 'pageview');</script>";
                // Disgusting hack  I promise to refactor this and push upstream and everything, to support multiple GA accounts, because that's a rational thing for a doc site ....
            }
        }
    }
};
