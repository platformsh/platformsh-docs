    ...
    book: {
        ...
        html: {
            "body:end": function() {
                ...
                + "ga('create', 'UA-4064131-7', 'auto' , {'name': 'marketplace'});"; //FIXME Disgusting hack
                + "ga('marketplace.send', 'pageview');"; // Disgusting hack  I promise to refactor this and push upstream and everything, to support multiple GA accounts, because that's a rational thing for a doc site ....
