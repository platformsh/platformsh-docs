...
listed in a ``.gitmodules`` file at the root of your Git repository. When you push via Git, 
...
you should not be using an SSH URL: ``git@github.com:...``, but you should use an HTTPS URL instead: ``https://github.com/...``.
