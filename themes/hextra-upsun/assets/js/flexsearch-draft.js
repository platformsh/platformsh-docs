...
(function () {
  ...
  for (const el of inputElements) {
    ...
    // }
      ...
      // search();
      let searchLanding = document.querySelectorAll('.search-landing');
      searchLanding[0].classList.add('hx-hidden');
  ...
  function handleKeyDown(e) {
    ...
    switch (e.key) {
      ...
      case 'Enter':
        ...
        //   activeResult.click();
        // }
        // let prevQuery = inputElement.value;
        // let { inputElement }  = getActiveSearchElement();
        window.location.href=`/search/?q=${inputElement.value}`;
        // console.log(inputElement.value);
        finishSearch();
        // console.log(inputElement.value);
        // let inputElements = document.querySelectorAll('.search-input');
        // let { inputElementUpdate }  = getActiveSearchElement();
        // console.log(inputElementUpdate)
        // inputElement.value = prevQuery;
      case 'Escape':
        e.preventDefault();
        hideSearchResults();
   ...
   */
  function search(e) {
    // let currentPathQuery = getParameterByName('q');
  ...
  function displayResults(results, query) {
    ...
    if (!results.length) {
      ...
      let searchLanding = document.querySelectorAll('.search-landing');
      searchLanding[0].classList.remove('hx-hidden');
      return;
    }
    searchLanding[0].classList.add('hx-hidden');
