...
The [MySQL, MariaDB](/configuration/services/mysql/_index.md),
and [Solr](/configuration/services/solr.md) services support defining multiple databases on a single service,
which is significantly more efficient than defining multiple services.
[Redis](/configuration/services/redis.md), [Memcached](/configuration/services/memcached.md),
[Elasticsearch](/configuration/services/elasticsearch.md), and [RabbitMQ](/configuration/services/rabbitmq.md)
