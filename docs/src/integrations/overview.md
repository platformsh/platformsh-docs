...
You can also add our native integrations with performance monitoring tools. Platform.sh owns and recommends [Blackfire](/integrations/observability/blackfire.md).By using Blackfire on Platform.sh, you will benefit from an enhanced experience and support, as well as upcoming unique features.
