...
You can also add our native integrations with performance monitoring tools such as Blackfire, New Relic, or Tideways, as well as setting up health notifications.  Or create your [own integration using our webhooks](/integrations/overview.md#validating-integrations).
