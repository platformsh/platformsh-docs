...
This assumes that a `network-storage` service named `files` has already been defined.  See the [Network Storage]({{< relref "/configuration/services/network-storage.md" >}}) page for more details and examples.
...
See the [web locations]({{< relref "/configuration/app/web.md" >}}) documentation for more details.
