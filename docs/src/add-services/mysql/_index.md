...
When you create an endpoint to allow your app and database to communicate,
an empty password is generated by default.
If you add multiple endpoints,
having empty passwords can cause issues with your app.
 
To solve this,
define custom endpoints in your [service configuration](#configuration-options).
...
You can access the `PLATFORM_RELATIONSHIPS` environment variable [in a shell](../../development/variables/use-variables.md#access-variables-in-a-shell)
or directly [in your app](../../development/variables/use-variables.md#access-variables-in-your-app), for example using the Platform.sh Configuration Reader.
 
When you switch from the default configuration with empty passwords to custom endpoints,
