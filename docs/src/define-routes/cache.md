...
You should _not_ use the Platform.sh HTTP cache if you're using Varnish or an external CDN such as [fastly](../domains/cdn/fastly.md) or [cloudflare](../domains/cdn/cloudflare.md).
