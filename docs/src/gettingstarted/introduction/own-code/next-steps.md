...
In this guide you created a project using the [CLI](/development/cli/_index.md) and configured your project to run on Platform.sh using a few simple configuration files.
