...
{{< note >}}
If your submodule contains an independent app, see [how to configure it properly](create-apps/multi-app/project-structure.md#separate-code-bases-in-one-repository).
{{< /note >}}
