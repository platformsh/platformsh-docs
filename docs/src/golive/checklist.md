...
Make sure your site is running and configured as you want it to be, on your master branch.  In particular, see the [Routes documentation]({{< relref "/configuration/routes/_index.md" >}}). You will need your routes configured appropriately before you begin.  Make sure you have turned off [basic-authentication]({{< relref "/administration/web/configure-environment.md" >}}) if it was turned on during development.
...
For Enterprise plans you may need to obtain a DNS TXT record from your Platform.sh support representative by opening a ticket.  Consult the documentation for your CDN provider and our own [CDN guide]({{< relref "/golive/cdn/_index.md" >}}).
...
**Time to [Go Live]({{< relref "/golive/steps/_index.md" >}}).**
