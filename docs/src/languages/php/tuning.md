...
It's also possible that your own code is doing more work than it needs to.  Profiling and optimizing a PHP application is a much larger topic than will fit here, but Platform.sh recommends enabling [Blackfire.io](/integrations/observability/blackfire.md) on your project to determine what slow spots can be found and addressed.
