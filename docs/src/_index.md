...
If you're new to Platform.sh, we recommend starting with the **Big Picture**, in particular [Structure](/overview/structure.md), and [Build & Deploy](./overview/build-deploy111.md) will get you started on the right track to best use Platform.sh.
