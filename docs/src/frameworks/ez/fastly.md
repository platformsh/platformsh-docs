...
See the alternate [Go-live process for Fastly]({{< relref "/golive/cdn/_index.md#client-authenticated-tls" >}}) on Platform.sh.  This process is the same for any application.
