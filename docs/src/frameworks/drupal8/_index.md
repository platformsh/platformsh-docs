...
If you need to add additional Platform.sh-specific configuration, such as to enable a [Redis server](/frameworks/drupal8/redis/) for caching, we recommend also putting it into `settings.platformsh.php`.
...
{{< readFile file="static/files/fetch/appyaml/drupal8" highlight="yaml" >}}
