...
There are two VCL files provided as starting point for use Fastly with Ibexa DXP, you can find them in `vendor/ezsystems/ezplatform-http-cache-fastly/fastly/*.vcl`.
