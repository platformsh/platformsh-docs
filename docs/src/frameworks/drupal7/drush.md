...
See the [documentation on Drush in Drupal 8](/frameworks/drupal8/drush.md) for installation, drush aliases, and other general information.  The installation procedure is the same for both Drupal 7 and 8.
