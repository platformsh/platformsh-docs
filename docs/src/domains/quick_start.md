...
{{< note >}}
[If that is not your case and you want more details](/domains/steps/_index.md)
[If you want to run a subdomain see this page first.](/domains/steps/subdomains.md)
{{< /note }}
