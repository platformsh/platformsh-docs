...
{{< note >}}
You are able to add a domain to your production (i.e. `Master`) environment. However, the domain used for non-production environments will always be generated and cannot be customized, even if your project is on a Production plan.
{{< /note >}}
