...
The examples files are set up in [a specific file](../docs/data/remote-examples/language-examples/examples.yaml).
If that file or any examples have changed, they need to be re-generated by running `npm run dev`.
## Reuse content
