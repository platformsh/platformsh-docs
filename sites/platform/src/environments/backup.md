...
1. As an [admin user](../administration/users.md), you can do a backup of your environment.
   ...
   and any files stored on [mounts](/create-apps/app-reference/builtin-image.md#mounts) are included.
...
You can also automate the process of creating manual backups through [cron jobs](/create-apps/app-reference/builtin-image.md#crons).
