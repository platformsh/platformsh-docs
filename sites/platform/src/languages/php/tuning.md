...
To change your PHP version, change the [`type` in your app configuration](/create-apps/app-reference/images/builtin-image.md#types).
...
```
`{{< variable "PRELOAD_SCRIPT" >}}` is a file path relative to the [app root](/create-apps/app-reference/images/builtin-image.md#root-directory).
...
2. Determine roughly how many `.php` files your app has by running this command from [your app root](/create-apps/app-reference/images/builtin-image.md#root-directory):
