...
To enable Xdebug, add the following to your [app configuration](/create-apps/app-reference/images/builtin-image.md):
...
4. Ensuring path mappings is enabled.
    ...
    In the majority of cases you can just define [your app root](/create-apps/app-reference/images/builtin-image.md#root-directory)
    to map to `app`.
