...
Replace `<START_FILE>` with the file defined for [your app's `start` command](/languages/nodejs/#4-start-your-app).
...
Instead of using a script, call `pm2 start` directly in your [`start` command](/languages/nodejs/#4-start-your-app).
