...
The application must use the [appropriate environment variable](/create-apps/app-reference/images/builtin-image.md#where-to-listen) to determine the URI to listen on.
