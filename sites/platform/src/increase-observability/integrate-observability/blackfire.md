...
2. In your Blackfire account, create an organization.
   ...
   [create a support ticket](/learn/overview/get-support.md) to activate your organization.
...
4. In your environment, click **Settings/Environment Credentials**.
5. Retrieve your Blackfire server ID and server token.
6. [Create a support ticket](/learn/overview/get-support.md) to send those credentials to Support so that they can complete the installation.
