...
If your app has its own logging mechanism, use it to write to a dedicated logs [mount](/create-apps/app-reference/images/builtin-image.md#mounts).
...
If you need larger logs, set up a [cron job](/create-apps/app-reference/images/builtin-image.md#crons) to upload them to third-party storage.
