...
Transferring data to and from [a {{% names/dedicated-gen-2 %}} cluster](/glossary/#dedicated-gen-2) slightly differs from the process on the Grid.
...
For more backup options and examples, see how to [export data from an SQL database](/add-services/mysql/#exporting-data).
...
For more granular connection options, see [SSH connection details](/development/ssh/#get-ssh-connection-details).
