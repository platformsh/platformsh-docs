...
| `{{< vendor/prefix >}}_ENVIRONMENT`      | No    | Yes     | The name of the Platform.sh environment. |
| `{{< vendor/prefix >}}_ENVIRONMENT_TYPE` | No    | Yes     | The environment type of the Platform.sh environment (`development`, `staging`, or `production`). |
