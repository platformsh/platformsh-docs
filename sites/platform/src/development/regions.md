...
For a given organization {{< variable "ORG\_NAME" >}}, run the following command:
...
1.  Navigate to the organization ({{< variable "ORG\_NAME" >}}) you'd like to audit at `https://console.upsun.com/ORG_NAME`.
    This view shows all of your projects within the organization {{< variable "ORG\_NAME" >}} (assuming you have at least [`projects:list`](/administration/users#organization-permissions) permissions on the organization).
