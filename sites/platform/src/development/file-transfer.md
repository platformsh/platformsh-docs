...
For more information, see the [{{% names/dedicated-gen-2 %}}](/dedicated-gen-2/architecture/options.html#sftp)
and [{{% names/dedicated-gen-3 %}}](/dedicated-gen-3/options.html#sftp) sections.
{{% /note %}}
