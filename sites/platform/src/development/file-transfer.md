...
[Mounts](/create-apps/app-reference/images/builtin-image.md#mounts) let you set up directories that remain writable after the build is complete.
...
(relative to the [app root](/create-apps/app-reference/images/builtin-image.md#root-directory)),
run the following command:
