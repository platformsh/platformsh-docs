...
In the [`web.locations` dictionary](/create-apps/app-reference/images/builtin-image.md#locations),
...
adjust the [`web.locations` dictionary](/create-apps/app-reference/images/builtin-image.md#locations).
Set up [rules](/create-apps/app-reference/images/builtin-image.md#rules) to allow only certain file extensions on a given path.
