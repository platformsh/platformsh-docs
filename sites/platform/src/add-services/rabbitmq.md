...
Please Note: RabbitMQ upgrades skipping major versions (e.g. 3.7 -> 3.11) is not supported due to feature flag requirements of later versions. When upgrading, please be sure to upgrade sequentially (3.7 -> 3.8 -> 3.9 -> 3.10 -> 3.11).
