...
Similar to [crons](/create-apps/app-reference/builtin-image.md#crons), they run in the app container but not on a specific schedule.
You can [define runtime operations](#define-a-runtime-operation) in your [app configuration](/create-apps/app-reference/builtin-image.md)
...
(meaning, you must [define a mount](/create-apps/app-reference/builtin-image.md#mounts) for it).
