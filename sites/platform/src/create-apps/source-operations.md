...
you can also define [cron jobs](/create-apps/app-reference/builtin-image.md#crons).
...
- A name that must be unique within the application.
  The name is the key of the block defined under `source.operations` in your [app configuration](/create-apps/app-reference/builtin-image.md#source).
