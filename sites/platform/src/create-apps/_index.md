...
The following example shows a setup for a PHP app with comments to explain the settings. Please note that the Composable image example is a Beta feature.
