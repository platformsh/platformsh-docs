...
Dynamic responses generated by your app aren't compressed by default,
because compressing them reintroduces the theoretical [BREACH](https://en.wikipedia.org/wiki/BREACH) attack surface.
If your framework mitigates BREACH, which most do by default,
you can opt in per location with the
[`dynamic_compression` setting](/create-apps/image-properties/web.md#dynamic-response-compression).
