...
<!-- TO-DO: Nov2025: Replace the info below with a link to/learn/overview/app-life-cycle.html#web-commands. 
Make sure that topic contains the generic info that's below. -->
