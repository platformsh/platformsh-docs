...
You can use any command you've added in [dependencies](/create-apps/app-reference/builtin-image.md#dependencies)
or a [hook](/create-apps/app-reference/builtin-image.md#hooks).
