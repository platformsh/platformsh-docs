...
It allows you to make your WordPress site [more stable, more secure, and easier to maintain](/guides/wordpress/composer/_index.md).
...
- Your project has been set up for deployment on {{% vendor/name %}}.
  ...
  [deploy WordPress without Composer](/guides/wordpress/vanilla/_index.md) before upgrading to a Composer-based site.
...
created when [you deployed your vanilla version](/guides/wordpress/vanilla/_index.md).
