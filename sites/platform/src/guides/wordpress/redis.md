...
* In your [app configuration](/create-apps/app-reference/images/builtin-image.md#extensions) (for extension versions tied to the PHP version)
...
Add the following line to the bottom of your `build` hook in your [app configuration](/create-apps/app-reference/images/builtin-image.md#hooks),
