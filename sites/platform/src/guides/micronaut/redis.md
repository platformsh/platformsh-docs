...
In your [app configuration](/create-apps/app-reference/images/builtin-image.md), use the service name `redisdata` to grant the application access to Elasticsearch via a relationship:
