...
In your [app configuration](/create-apps/app-reference/images/builtin-image.md), use the service name `dbmongo` to grant the application access to MongoDB via a relationship:
