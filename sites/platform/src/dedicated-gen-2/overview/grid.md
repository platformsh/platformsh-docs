...
How [cron tasks](/create-apps/app-reference/images/builtin-image.md#crons) interact with deploys changes based on the environment.
...
* [Worker instances](/create-apps/app-reference/images/builtin-image.md#workers)
...
* Web server configuration (the [`web.locations` section of your app configuration](/create-apps/app-reference/images/builtin-image.md#locations))
