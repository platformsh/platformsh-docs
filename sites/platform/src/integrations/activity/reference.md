...
```json {no-copy="true"}
{
  "id": "abcdefg123456",
  ...
  "created_at": "{{< current-year >}}-01-01T14:28:17.890467+00:00",
  "updated_at": null,
  ...
  "state": "complete",
  "result": "success",
  "started_at": "{{< current-year >}}-01-01T14:28:18.188888+00:00",
  "completed_at": "{{< current-year >}}-01-01T14:31:48.809068+00:00",
  ...
  "expires_at": "{{< current-year >}}-01-02T14:28:17.890467+00:00"
}
```
...
| `environment.merge`                  | An environment was [merged](/glossary/#merge) through the CLI, Console, or API. A basic Git merge doesn't trigger this activity.                                                                                               |
...
```json {no-copy="true"}
{
  ...
  "created_at": "{{< current-year >}}-01-01T16:06:08.081312+00:00",
  "updated_at": null,
  ...
  "state": "complete",
  "result": "success",
  "started_at": "{{< current-year >}}-01-01T16:06:08.258090+00:00",
  "completed_at": "{{< current-year >}}-01-01T16:07:09.658339+00:00",
  "completion_percent": 100,
  "cancelled_at": null,
  "timings": {
    "wait": 0,
  ...
  "payload": {
    "user": {
      "id": "admin",
      "created_at": "{{< current-year >}}-01-01T16:06:08.066085+00:00",
      "updated_at": null,
      "display_name": "{{% vendor/name %}} Bot"
    },
    "project": {
      "id": "abcdefgh1234567",
      "created_at": "{{< current-year >}}-01-01T15:47:28.739099+00:00",
      "updated_at": "{{< current-year >}}-01-01T19:42:19.860188+00:00",
      "attributes": {},
      "title": "php-test",
      "description": "",
    ...
    "environment": {
      "id": "main",
      "created_at": "{{< current-year >}}-01-01T15:47:43.750880+00:00",
      "updated_at": "{{< current-year >}}-01-01T16:16:37.085719+00:00",
      "name": "main",
      ...
      "deployment_state": {
        ...
        "last_deployment_at": "{{< current-year >}}-01-01T16:16:37.085609+00:00",
        "crons": {
          "enabled": true,
          "status": "running"
        }
      ...
      "resources_overrides": {},
      "last_active_at": "{{< current-year >}}-01-01T15:07:10.862854+00:00",
      "last_backup_at": null,
      "project": "abcdefgh1234567",
      "is_main": true,
      "is_dirty": false,
  ...
  "expires_at": "{{< current-year >}}-01-01T16:06:08.081293+00:00"
}
```
...
...
    "environment": {
      ...
      "resources_overrides": {},
      "last_active_at": "{{< current-year >}}-01-01T16:07:09.788910+00:00",
      "last_backup_at": null,
      "project": "abcdefgh1234567",
      "is_main": true,
      "is_dirty": false,
...
...
 "deployment": {
      "id": "current",
      "created_at": "{{< current-year >}}-01-01T15:48:05.396979+00:00",
      "updated_at": "{{< current-year >}}-01-01T15:41:57.264813+00:00",
      "cluster_name": "abcdefgh1234567-main-abcd123",
      "project_info": {
          "deployment": {
      "id": "current",
      "created_at": "{{< current-year >}}-01-01T15:48:05.396979+00:00",
      "updated_at": "{{< current-year >}}-01-01T16:41:57.264813+00:00",
      "cluster_name": "abcdefgh1234567-main-abcd123",
      "project_info": {
...
```json {no-copy="true"}
{
  ...
  "created_at": "{{< current-year >}}-01-01T15:41:05.821145+00:00",
  "updated_at": null,
  ...
  "state": "complete",
  "result": "success",
  "started_at": "{{< current-year >}}-01-01T15:41:05.969872+00:00",
  "completed_at": "{{< current-year >}}-01-01T15:41:57.635442+00:00",
  "completion_percent": 100,
  "cancelled_at": null,
  "timings": {
    "wait": 0,
  ...
  "expires_at": "{{< current-year >}}-01-01T15:41:05.821145+00:00"
}
```
