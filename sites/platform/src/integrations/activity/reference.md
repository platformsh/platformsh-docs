...
When a cron job is triggered, the activity contains all the [job's information](/create-apps/app-reference/images/builtin-image.md#crons).
...
including the [image type](/create-apps/app-reference/images/builtin-image.md#types) and
[resource allocation](/create-apps/app-reference/images/builtin-image.md#sizes).
