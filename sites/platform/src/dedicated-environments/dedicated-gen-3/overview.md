...
-   **Better containerization:** DG3 is containerized and decouples the base operating system (OS) version and [control plane](/glossary/#control-plane) from the service versions, so the OS and services can be upgraded independently
