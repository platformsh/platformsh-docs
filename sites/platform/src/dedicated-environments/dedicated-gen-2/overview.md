...
For a broader list of supported third-party destinations and configuration details, see [Third-party log forwarding integrations](/increase-observability/logs/forward-logs.md#use-a-log-forwarding-integration).
