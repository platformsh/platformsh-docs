...
Routes are defined in the `.routes` top-level key in your project’s configuration file (for example, {{% vendor/configfile "app"%}}), and they map specific URLs or domains to one of the following actions:
