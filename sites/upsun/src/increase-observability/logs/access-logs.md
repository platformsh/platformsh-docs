...
| ------------- | -------------- | ----------- |
| `access`      | Yes            | The raw access log for t`he nginx instance running on the container. It doesn't include requests that are redirected or cached by the [router](../../define-routes/_index.md). |
