...
| Retired | Upstream security support ends. Image is frozen, provided as-is and not maintained. |	Limited support	| Upgrade as soon as possible |
| Decommissioned | Image is no longer available. Builds using it will fail. | - | Migration required to continue deploying |
