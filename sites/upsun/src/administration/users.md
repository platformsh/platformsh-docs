...
{{% vendor/name %}} offers free viewer permissions as part of the [Standard User Management add-on](/administration/billing/add-ons.html#standard-user-management-add-on).
...
To be able to create custom organization permissions, [upgrade to the Standard User Management add-on](/administration/billing/add-ons.html#standard-user-management-add-on).
