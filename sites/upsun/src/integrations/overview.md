...
2. When prompted, select an integration.
   ...
   +---------------+---------------------------+-------------------------------------------------------------+----------+---------+
   | 6456zmdtoykxa | {{< current-year >}}-04-14T16:38:09-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | wcwp34yjvydgk | {{< current-year >}}-04-14T16:35:22-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | w2bp3oa5xbfoe | {{< current-year >}}-04-14T16:33:13-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | uqqvdyxmcdmsa | {{< current-year >}}-04-14T16:31:45-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | 7x3wefhh4fwqc | {{< current-year >}}-04-14T16:30:36-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | a46aah3ga65gc | {{< current-year >}}-04-14T16:29:46-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | r7erid2jlixgi | {{< current-year >}}-04-14T16:24:50-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | ieufk3vvde5oc | {{< current-year >}}-04-14T16:24:49-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | bc7ghg36ty4ea | {{< current-year >}}-04-14T15:30:17-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   | 4qojtv7a6rk2w | {{< current-year >}}-04-14T15:27:26-05:00 | Fetching from https://github.com/platformsh/platformsh-docs | complete | success |
   +---------------+---------------------------+-------------------------------------------------------------+----------+---------+
   ```
...
Created: {{< current-year >}}-04-15T08:44:07-05:00
State: complete
Log:
[{{< current-year >}}-04-15T13:44:17-05:00] Waiting for other activities to complete
[{{< current-year >}}-04-15T13:46:07-05:00] Fetching from GitHub repository platformsh/platformsh-docs
[{{< current-year >}}-04-15T13:46:09-05:00]   No changes since last fetch
[{{< current-year >}}-04-15T13:46:09-05:00]
[{{< current-year >}}-04-15T13:46:09-05:00] Synchronizing branches
[{{< current-year >}}-04-15T13:46:09-05:00]
[{{< current-year >}}-04-15T13:46:09-05:00] Synchronizing pull requests
[{{< current-year >}}-04-15T13:46:59-05:00]
[{{< current-year >}}-04-15T13:46:59-05:00] W: No changes found, scheduling a retry..
```
