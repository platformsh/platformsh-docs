...
{
  "attributes": {},
  "created_at": "{{< current-year >}}-03-15T19:50:09.514267+00:00",
  "default_domain": null,
  "description": "",
  ...
  "updated_at": "{{< current-year >}}-04-21T17:15:35.526498+00:00"
}
```
...
HMAC(HMAC(HMAC(HMAC("AWS4" + kSecret,"{{< current-year >}}0830"),"us-east-1"),"iam"),"aws4_request");
```
