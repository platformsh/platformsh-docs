...
For some advanced use cases, you can use the [`PLATFORM_RELATIONSHIPS` environment variable](/development/variables/#service-environment-variables).
...
Note that ``SEARCH_URL``, and all {{% vendor/name %}} [service environment variables](/development/variables/#service-environment-variables) like ``SOLR_HOST``, are environment-dependent.
