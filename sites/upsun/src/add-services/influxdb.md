...
Note that ``INFLUX_HOST``, and all [{{% vendor/name %}}-service environment variables](/development/variables/#service-environment-variables) like ``INFLUXDBDATABASE_HOST``,
