...
Also, note that if you use a [custom start command](/languages/php/#alternate-start-commands),
...
They can be set the same way as any other [PHP setting](/languages/php/#php-settings).
