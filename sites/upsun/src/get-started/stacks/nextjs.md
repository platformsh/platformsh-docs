...
If you don’t have a local Next.js project, you need to create one locally by following the official Next.js [installation guide](https://nextjs.org/docs/getting-started/installation).
...
For example, edit the `src/app/page.tsx` file and make the following changes:

```diff
diff --git a/src/app/page.tsx b/src/app/page.tsx
index d2c63a4..156b52c 100644
--- a/src/app/page.tsx
+++ b/src/app/page.tsx
...
+          Make changes for Upsun preview environment.
        </p>
        <div>
        <a
```
