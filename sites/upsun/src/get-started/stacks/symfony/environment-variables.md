...
If you're using the [Symfony integration](/get-started/stacks/symfony/integration.md),
...
- `MAILFROM` is set to a random value.
  This value is used as a `From` header when using [croncape](/get-started/stacks/symfony/crons.md#use-croncape).
...
When using the [Symfony integration](/get-started/stacks/symfony/integration.md), information about services
...
The [MySQL/MariaDB](/add-services/mysql.html) configuration is exposed via the following environment variables
...
The [PostgreSQL](/add-services/postgresql.html) configuration is exposed via the following environment variables
...
The [Redis](/add-services/redis.html) configuration is exposed via the following environment variables
...
The [Memcached](/add-services/memcached.html) configuration is exposed via the following environment variables
...
The [Elasticsearch](/add-services/elasticsearch.html) configuration is exposed via the following environment variables
...
The [Apache Solr](/add-services/solr.html) configuration is exposed via the following environment variables
...
The [RabbitMQ](/add-services/rabbitmq.html) configuration is exposed via the following environment variables
...
The [MongoDB](/add-services/mongodb.html) configuration is exposed via the following environment variables
...
The [InfluxDB](/add-services/influxdb.html) configuration is exposed via the following environment variables
...
The [Apache Kafka](/add-services/kafka.html) configuration is exposed via the following environment variables
