...
copy_lib() {
   ...
   cp -r "${PLATFORM_CACHE_DIR}/${UPSUN_BINARY}" "${PLATFORM_APP_DIR}/bin/${UPSUN_TOOL}";
...
pandoc $PLATFORM_APP_DIR/sites/upsun/public/llms.txt --from=html -o $PLATFORM_APP_DIR/sites/upsun/public/llms.txt.md -t markdown
