...
To set headers for static content, add them in [your `web` configuration](/create-apps/app-reference/images/builtin-image.md#web).
...
Now set up an exception for MP3 files using a [rule](/create-apps/app-reference/images/builtin-image.md#rules):
